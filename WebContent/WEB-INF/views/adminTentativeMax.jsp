...
<html>
<head>
<title>Gestion des tentatives d'acces</title>
...
<body onload="pop()">
	...
	<h4>Administration : Gestion des tentatives d'acces (avant blocage)</h4>

	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<form method="post" id="formRegex" 	action="<c:url value="/adminTentativeMax" />" name="formRegex" role="form">
					<fieldset>
						<br>						
						<div class="form-group">
							<label for="login"><span class="req">* </span> Nombre de tentative (avant blocage) : </label> <input
								class="form-control" type="text" name="nb" id="nb"
								onkeyup="" placeholder="Inscrire le nombre de tentative" required />
								<br>
							<div id="errLast"></div>
						</div>
