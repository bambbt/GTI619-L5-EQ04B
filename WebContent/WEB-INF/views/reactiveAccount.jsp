...
<nav class="navbar navbar-light bg-faded">
	<ul class="nav navbar-nav">
		...
		<li class="nav-item"><a href="<c:url value="/reactiveAccount" />">Reactivation
				de compte</a></li>
...
<body onload="pop()">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							<th>Identifiant</th>
							<th>Login</th>
							<th>Compte désactivé</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${userList}" var="item">
							<tr>
								<td><c:out value="${item.iduser}" /></td>
								<td><c:out value="${item.login}" /></td>
								<td><c:out value="${item.isLocked==1}" /></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<form method="post" id="formReactiveAccount"
					action="<c:url value="/reactiveAccount" />"
					name="formReactiveAccount" role="form">
					<fieldset>
						<br>
						<div class="form-group">
							<label for="login"><span class="req">* </span> Login a
								reactive : </label> <input class="form-control" type="text" name="login"
								id="login" onkeyup="" placeholder="Inscrire le login" required />
							<br>
							<div id="errLast"></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="paswdAdmin"><span class="req">* </span>
								...
								name="adminPass" type="password" class="form-control inputpass"
