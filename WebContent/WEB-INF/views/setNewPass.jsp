...
<link href="<c:url value='/ressources/css/login.css' />"
	rel="stylesheet"></link>
...
<body onload="popInfo2()">
		...
		<div class="login-container">
			<div class="form-box">
				<form method="post" id="fileForm"
					action="<c:url value="/setNewPass" />" name="newPassformValideUser"
					...
					<div class="input-group input-sm">
						<label class="input-group-addon" for="username"><i
							...
							id="username" name="uid" placeholder="nom d'utilisateur"
							value="${user}" required />
					</div>
					<br>
					...
					<div class="input-group input-sm">
						<label for="password"><span class="req">* </span> PIN : </label> <br>
					...
					<div class="input-group input-sm">
						<label for="password"><span class="req">* </span> Nouveau
							mot de passe : </label> <br> <input required name="password"
							type="password" class="form-control inputpass" id="pass1"
							maxlength="16" placeholder="Saisir nouveau mot de passe"
							id="pass1" required /> <br> <input name="passwordAgain"
							type="password" class="form-control inputpass" maxlength="16"
							placeholder="Confirmer mot de passe" id="pass2"
							onkeyup="validationMDP()" required /> <span id="confirmMessage"
	...
	<input type="button"
		onClick="document.location.href = document.referrer" value="Retour" />
</body>
</html>