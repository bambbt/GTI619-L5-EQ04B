  ...
  <div class="jumbotron">
	...
	<br><br>
		...
		<div class="form-group row">
		  ...
		  <div class="col-xs-10">
		   		<input type="number" id="recovery" step="1" value="0" min="0" max="9999999999" placeholder="Saisir le PIN reçu par mail" required> 
		  </div>
		</div>
		...
		<div class="form-group row">
		  ...
		  <div class="col-xs-10">
		    <input type="password" class="form-control" id="pass1" name="password" maxlength="16" placeholder="Saisir le nouveau mot de passe" required>
		  </div>
		</div>
		<div class="form-group row">
		  <label for="example-password-input" class="col-xs-2 col-form-label">Confirmation</label>
		  <div class="col-xs-10">
		    <input type="password" class="form-control" id="pass2" name="passwordAgain" maxlength="16" placeholder="Confirner le mot de passe" required>
		  </div>
